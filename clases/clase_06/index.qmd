...
<section class="clase-hero">
  ...
  <p><a class="btn btn-primary" href="informe_practica_bienestar_prueba.qmd" download>Descargar script</a></p>
</section>
```
...
```{r}
#| label: cargar-paquetes-completo
#| eval: false
...
```{r}
#| label: tbl-descriptivos-completo
#| tbl-cap: "Medidas descriptivas de variables numéricas"
#| echo: false
#| eval: false
